<div class="container h-full mx-auto flex justify-center items-center">
	<div class="space-y-10 text-center flex flex-col items-center">
		<!--
		<h2 class="h2">Esonhugh private resource hosting</h2>
		// Animated Logo
		 / -->
		<figure>
		...
		<div class="">
			...
			<div class="p-4">
				<p class="p-4">
					Visit <a class="text-red-600 hover:text-red-700" href="https://kit.svelte.dev"
						>kit.svelte.dev</a
					> to read the documentation
				</p>
				<p class="p-4">
					Visit <a class="text-red-600 hover:text-red-700" href="https://skeleton.dev"
						>skeleton.dev</a
					> to read the UI framework documentation
				</p>
			</div>
		</div>
	</div>
